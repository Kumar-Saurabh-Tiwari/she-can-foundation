...
const appCss = "/assets/styles-Dt9ormNO.css";
...
const $$splitComponentImporter = () => import("./index-CFzWhhkL.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "She Can Foundation creates beginner-friendly spaces where young women learn, code, and grow into the next generation of leaders in tech."
    }, {
      property: "og:title",
      content: "She Can Foundation"
    }, {
